  ...
  const videos: Video[] = [
    {
      ...
      description:
        "A comprehensive guide to understanding the physical and emotional changes during puberty",
      duration: "8:45",
      views: "12.5K",
    ...
    },
    {
      ...
      description:
        "Learn how your choices today impact your tomorrow and how to set yourself up for success",
      duration: "6:30",
      views: "18.2K",
    ...
    },
    {
      ...
      description:
        "Understanding the health, social, and educational impacts of teenage pregnancy",
      duration: "10:15",
      views: "25.8K",
      category: "Awareness",
      thumbnail:
        "https://images.unsplash.com/photo-1493894473891-10fc1e5dbd22?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    },
    {
      id: "4",
      title: "How to Talk to Your Parents",
      description:
        "Tips and strategies for having important conversations with parents and trusted adults",
      duration: "7:20",
      views: "9.4K",
      category: "Communication",
      thumbnail:
        "https://images.unsplash.com/photo-1516534775068-ba3e7458af70?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    },
    {
      id: "5",
      title: "Building Self-Confidence and Self-Worth",
      description:
        "Learn to value yourself and make decisions that align with your goals and values",
      duration: "9:00",
      views: "14.1K",
      category: "Mental Health",
      thumbnail:
        "https://images.unsplash.com/photo-1543269865-cbf427effbad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    },
    {
      id: "6",
      title: "Recognizing and Avoiding Peer Pressure",
      description:
        "Strategies to stay true to yourself and resist negative influences from peers",
      duration: "8:10",
      views: "11.7K",
      category: "Life Skills",
      thumbnail:
        "https://images.unsplash.com/photo-1529390079861-591de354faf5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    },
    {
      id: "7",
      title: "Your Educational Journey Matters",
      description:
        "Why staying in school is crucial for your future and how to overcome challenges",
      duration: "7:45",
      views: "16.3K",
      category: "Education",
      thumbnail:
    ...
    },
    {
      ...
      description:
        "Where to find help, who to talk to, and resources available for young people",
      duration: "6:55",
      views: "8.9K",
      category: "Support",
      thumbnail:
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-700 leading-relaxed">
                ...
                decision-making, and planning for your future. All content is
                age-appropriate and factually accurate.
              </p>
            </div>
          </CardContent>
        </Card>
